...
os.system("clear")
os.system("title Discord Acount Hoster Loading Config - ! - 𝘒 𝘌 𝘕#2836")
token = input(f"! - 𝘒 𝘌 𝘕#2836 | Enter Discord Account Token: ")
os.system("clear")
...
@client.event
async def on_ready():
  os.system("title Discord Account Hoster Account Hosted Successfully - [! - 𝘒 𝘌 𝘕#2836]")
  if lowertext == "idle":
